...
func (_m *MockEventPublisher) Publish(ctx context.Context, event video.DomainEvent) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, video.DomainEvent) error); ok {
		r0 = rf(ctx, event)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockEventPublisher_Publish_Call) Run(run func(ctx context.Context, event video.DomainEvent)) *MockEventPublisher_Publish_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(video.DomainEvent))
	})
	return _c
}
...
func (_c *MockEventPublisher_Publish_Call) RunAndReturn(run func(context.Context, video.DomainEvent) error) *MockEventPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
